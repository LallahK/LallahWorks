...
.next_arg :
  mov edi , dword argv ;
  test edi , edi ; test for a NULL pointer ; if it is , we are at the end
  jz .exit ; of the argv array
  call strlen ; gets string address via edi , returns length via edx
