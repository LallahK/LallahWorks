...
/**
 * Mutates every line of the chosen egg by Parental Crossover
 * systematically generating the interval
 *
 * @param chosenEgg The egg to be mutated
 * @param bestEgg The best egg to be used as a parent 
