...
def test01(polar_to_cartesian):
    """polar_to_cartesian(2, 60, 3), which expects '(1.000, 1.732)'"""
    with nostdout(), time_limit(1):
        coords = polar_to_cartesian(2, 60, 3)
    return coords == '(1.000, 1.732)'

def test02(polar_to_cartesian):
    """polar_to_cartesian(5, 45, 7), which expects '(3.5355339, 3.5355339)'"""
    with nostdout(), time_limit(1):
        coords = polar_to_cartesian(5, 45, 7)
    return coords == '(3.5355339, 3.5355339)'

def test03(polar_to_cartesian):
    """polar_to_cartesian(5, -53, 2), which expects '(3.01, -3.99)'"""
    with nostdout(), time_limit(1):
        coords = polar_to_cartesian(5, -53, 2)
    return coords == '(3.01, -3.99)'

def test04(polar_to_cartesian):
    """polar_to_cartesian(5, -53, 0), which expects '(3, -4)'"""
    with nostdout(), time_limit(1):
        coords = polar_to_cartesian(5, -53, 0)
    return coords == '(3, -4)'

def test05(polar_to_cartesian):
    """polar_to_cartesian(5, 127, 5), which expects '(-3.00908, 3.99318)'"""
    with nostdout(), time_limit(1):
        coords = polar_to_cartesian(5, 127, 5)
    return coords == '(-3.00908, 3.99318)'

def test06(polar_to_cartesian):
    """polar_to_cartesian(1, 90, 1), which expects '(0.0, 1.0)'"""
    with nostdout(), time_limit(1):
        coords = polar_to_cartesian(1, 90, 1)
    return coords == '(0.0, 1.0)'

def test07(polar_to_cartesian):
    """polar_to_cartesian(3, 0, 4), which expects '(3.0000, 0.0000)'"""
    with nostdout(), time_limit(1):
        coords = polar_to_cartesian(3, 0, 4)
    return coords == '(3.0000, 0.0000)'
...
def set_up_tests():
    mts = ModuleTestSetup('coords.py')
    fts = FunctionTestSetup(mts, 'polar_to_cartesian', 'test')
