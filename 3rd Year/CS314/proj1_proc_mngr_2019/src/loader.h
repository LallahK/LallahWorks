...
/**
 * Data structure used for the queues. Includes a pointer to a process
 * control block along with a pointer to another processQueue object.
 * Allows for the creation of a linked list as the object used for the
 * queues.
 */
struct processQueue {
  /** Pointer to processControlBlock pointer */
  struct processControlBlock *pcb;
  /** Pointer to next processQueue node */
