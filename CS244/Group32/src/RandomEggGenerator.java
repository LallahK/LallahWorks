 ...
 * by initially generating and saving all possible baords and saving them to
 * be used at a later stage when a random board needs to be generated 
 *
 ...
 * wherevy every possible row is found
 *
 * @param rowOptions The 2D boolean array of options for a row
